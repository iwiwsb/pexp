...
pub const IMAGE_FILE_RELOCS_STRIPPED: [u8; 2] = [0x01, 0x00];
/// Image only. This indicates that the image file is valid and can be run. If this flag is not set,
/// it indicates a linker error.
pub const IMAGE_FILE_EXECUTABLE_IMAGE: [u8; 2] = [0x02, 0x00];
/// COFF line numbers have been removed. This flag is deprecated and should be zero.
pub const IMAGE_FILE_LINE_NUMS_STRIPPED: [u8; 2] = [0x04, 0x00];
/// COFF symbol table entries for local symbols have been removed. This flag is deprecated and
/// should be zero.
pub const IMAGE_FILE_LOCAL_SYMS_STRIPPED: [u8; 2] = [0x08, 0x00];
/// Obsolete. Aggressively trim working set. This flag is deprecated for Windows 2000 and later and must be zero.
pub const IMAGE_FILE_AGGRESSIVE_WS_TRIM: [u8; 2] = [0x10, 0x00];
/// Application can handle > 2-GB addresses.
pub const IMAGE_FILE_LARGE_ADDRESS_AWARE: [u8; 2] = [0x20, 0x00];
/// This flag is reserved for future use.
pub const IMAGE_FILE_RESERVED0: [u8; 2] = [0x40, 0x00];
...
pub const IMAGE_FILE_BYTES_REVERSED_LO: [u8; 2] = [0x80, 0x00];
/// Machine is based on a 32-bit-word architecture.
pub const IMAGE_FILE_32BIT_MACHINE: [u8; 2] = [0x00, 0x01];
/// Debugging information is removed from the image file.
pub const IMAGE_FILE_DEBUG_STRIPPED: [u8; 2] = [0x00, 0x02];
/// If the image is on removable media, fully load it and copy it to the swap file.
pub const IMAGE_FILE_REMOVABLE_RUN_FROM_SWAP: [u8; 2] = [0x00, 0x04];
/// If the image is on network media, fully load it and copy it to the swap file.
pub const IMAGE_FILE_NET_RUN_FROM_SWAP: [u8; 2] = [0x00, 0x08];
/// The image file is a system file, not a user program.
pub const IMAGE_FILE_SYSTEM: [u8; 2] = [0x00, 0x10];
...
pub const IMAGE_FILE_DLL: [u8; 2] = [0x00, 0x20];
/// The file should be run only on a uniprocessor machine.
pub const IMAGE_FILE_UP_SYSTEM_ONLY: [u8; 2] = [0x00, 0x40];
/// Big endian: the MSB precedes the LSB in memory. This flag is deprecated and should be zero.
pub const IMAGE_FILE_BYTES_REVERSED_HI: [u8; 2] = [0x00, 0x80];
