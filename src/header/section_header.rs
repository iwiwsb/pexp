...
#[derive(Debug)]
pub struct SectionHeaderReader<R: Read + Seek> {
    offset: u64,
    reader: R,
}
...
pub struct SectionHeader {
    ...
    pub virtual_size: StructField<[u8; 4]>,
    ...
    pub size_of_raw_data: StructField<[u8; 4]>,
    /// The file pointer to the first page of the section within the COFF file.
    /// For executable images, this must be a multiple of [`file_alignment`](crate::header::optional_header::OptionalHeader#structfield.file_alignment) from the [`OptionalHeader`](crate::header::optional_header::OptionalHeader).
    /// For object files, the value should be aligned on a 4-byte boundary for best performance.
    /// When a section contains only uninitialized data, this field should be zero.
    pub pointer_to_raw_data: StructField<[u8; 8]>,
    /// The file pointer to the beginning of relocation entries for the section.
    /// This is set to zero for executable images or if there are no relocations.
    pub pointer_to_relocations: StructField<[u8; 8]>,
    /// The file pointer to the beginning of line-number entries for the section.
    /// This is set to zero if there are no COFF line numbers.
    /// This value should be zero for an image because COFF debugging information is deprecated.
    pub pointer_to_linenumbers: StructField<[u8; 8]>,
    /// The number of relocation entries for the section.
    /// This is set to zero for executable images.
    pub number_of_relocations: StructField<[u8; 8]>,
    /// The number of line-number entries for the section.
    /// This value should be zero for an image because COFF debugging information is deprecated.
    pub number_of_linenumbers: StructField<[u8; 8]>,
    /// The [flags](crate::header::section_flags) that describe the characteristics of the section.
    pub characteristics: StructField<[u8; 4]>,
}

impl<R: Read + Seek> SectionHeaderReader<R> {
